...
public class Product {
    ...
    public String toString() {
        return "ID=" + productID + ", Name=" + productName + ", qPerUnit=" + quantityPerUnit + ", uPrice=" + unitPrice + ", uInStock=" + unitsInStock + ", uOnOrder=" + unitsOnOrder + ", rorderLevel=" + reorderLevel + ", discontinued=" + discontinued;
    }
}
